...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    // create a timestamp of current date and time
    const now = new Date();
    const options = {
      hour: 'numeric',
      minute: 'numeric',
...
// console.log(+'23'); //converting string to number (type coercion)

// // parsing
// console.log(Number.parseInt('30px', 10));
// console.log(Number.parseInt('e30blabla', 10));

// console.log(Number.parseFloat('2.5 rem'));

// // check is value is NaN
// console.log(Number.isNaN(20));
// console.log(Number.isNaN(+`20e`));
// console.log(Number.isNaN(23 / 0)); // infinity is NaN!
...
// console.log(Math.max(5, 18, 23, 11, 3));
// console.log(Math.min(5, 18, 23, 11, 3));

// console.log(Math.PI * Number.parseFloat(`10px`) ** 2); // calculate the radius of a 10px wide circle
...
// console.log(30952730527359827305927305927305975092750182n)
// console.log(BigInt(30952730527359827305927305927305975092750182))

// // operations
// console.log(10000n + 10000n);
// console.log(3852835982309582336523634658658769870674n * 1253264343643652n);

// const huge = 325982350918254634806834n;
// const num = 42
...
// console.log(20n == 20); // type coercion -> coerced bigint to regular int
// console.log(20n == '20');
...
// console.log(new Date('Jun 07 2022 10:53:27'));
...
// console.log(new Date(1654589820314));
